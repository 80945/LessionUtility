...
{
    CGRect rect = self.isRadius ? CGRectInset(self.bounds, kBorderWidth, kBorderWidth) : self.bounds;
    CGFloat radius = self.isRadius ? CGRectGetHeight(rect) / 2.0f : 0;
    ...
    CGRect progressRect = self.isRadius ? CGRectInset(rect, 2 * kBorderWidth, 2 * kBorderWidth) : self.bounds;
    CGFloat progressRadius = self.isRadius ? CGRectGetHeight(progressRect) / 2.0f : 0;
